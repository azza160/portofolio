                ...
                >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {project.images.map((img, idx) => (
                            <div key={idx} className={`relative rounded-md border border-border/50 overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300 aspect-video ${idx === 0 && project.images.length % 2 !== 0 ? "md:col-span-2" : ""}`}>
                                <Image
                                    src={img}
                        ...
                        >
                            ...
                            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                {project.features.map((feature, idx) => (
                                    <li key={idx} className="flex items-start gap-3 p-4 rounded-md bg-secondary/30 border border-border/50">
